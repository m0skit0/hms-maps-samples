...
class PolylineDemoActivity :
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.polyline_demo_hms)
    ...
    override fun onMapReady(huaweiMap: HuaweiMap?) {
        ...
        with(huaweiMap) {
            ...
            // Move the huaweiMap so that it is centered on the mutable polyline.
        ...
        mutablePolyline = huaweiMap.addPolyline(PolylineOptions().apply{
