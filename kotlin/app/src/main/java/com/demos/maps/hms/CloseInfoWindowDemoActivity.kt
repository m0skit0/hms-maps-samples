...
class CloseInfoWindowDemoActivity :
     ...
     */
    private val markerClickListener = object : HuaweiMap.OnMarkerClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_marker_close_info_window_on_retap_demo_hms)
