...
class LiteListDemoActivity : AppCompatActivity() {
    ...
    /**
     * RecycleListener that completely clears the [com.google.android.gms.maps.huaweiMap]
     * attached to a row in the RecyclerView.
     * Sets the map type to [com.google.android.gms.maps.huaweiMap.MAP_TYPE_NONE] and clears
     * the map.
     */
        ...
        inner class ViewHolder(view: View) :
            ...
            init {
                with(mapView) {
                    ...
                    onCreate(null)
                    // Set the map ready callback to receive the huaweiMap object
            ...
            fun clearView() {
                with(map) {
                    ...
                    clear()
                    mapType = HuaweiMap.MAP_TYPE_NONE
                }
            }
        }
    }
