...
class MarkerDemoActivity :
        ...
        HuaweiMap.OnInfoWindowCloseListener,
    ...
    /**
     * This is the callback that is triggered when the huaweiMap has loaded and is ready for use
     */
    override fun onMapReady(huaweiMap: HuaweiMap?) {
        ...
        // Add lots of markers to the huaweiMap.
        addMarkersToMap()
